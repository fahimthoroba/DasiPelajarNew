...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-display font-bold text-gray-900 dark:text-white">Edit Program Kerja</h1>
        </div>
        ...
        <form action="{{ route('dashboard.pac.proker.update', $program->id) }}" method="POST"
            ...
            <div class="lg:col-span-2 space-y-6">
                <div
                    ...
                    <!-- Departemen (Added) -->
                    <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Departemen Penanggung Jawab</label>
                        <select name="departemen_id" required
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-surface-light dark:bg-gray-900 focus:border-emerald-500 focus:ring-emerald-500/20 transition-all">
                            <option value="">-- Pilih Departemen --</option>
                            @foreach($departemens as $dept)
                                <option value="{{ $dept->id }}" {{ old('departemen_id', $program->departemen_id) == $dept->id ? 'selected' : '' }}>
                    ...
                    <!-- Kategori (Simple Select for Edit) -->
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">*Jika ingin kategori baru, silakan buat di menu 'Tambah
                            Kegiatan'.</p>
            ...
            <div class="lg:col-span-1 space-y-6">
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-2">*Perubahan status ke "Pasti" akan mengunci jadwal.</p>
                    </div>
